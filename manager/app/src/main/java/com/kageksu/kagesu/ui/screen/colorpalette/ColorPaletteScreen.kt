...
fun ColorPaletteScreen() {
    ...
    val actions = ColorPaletteScreenActions(
        ...
        onPickBackgroundImage = viewModel::pickBackgroundImage,
        onClearBackgroundImage = viewModel::clearBackgroundImage,
        onSetBackgroundDim = viewModel::setBackgroundDim,
        onSetBackgroundBlurEnabled = viewModel::setBackgroundBlurEnabled,
        onSetBackgroundBlurRadius = viewModel::setBackgroundBlurRadius,
