package com.kageksu.kagesu.ui.screen.settings
...
import com.kageksu.kagesu.ui.util.rememberKpmAvailable
...
fun SettingPager(
    ...
    val actions = SettingsScreenActions(
        ...
        onOpenBackupRestore = { navigator.push(Route.BackupRestore) },
    )
