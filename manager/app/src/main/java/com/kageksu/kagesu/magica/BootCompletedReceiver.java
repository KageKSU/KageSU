package com.kageksu.kagesu.magica;

import static com.kageksu.kagesu.magica.AppZygotePreload.TAG;
...
import com.kageksu.kagesu.ui.util.KsuCliKt;
...
public class BootCompletedReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (!Intent.ACTION_LOCKED_BOOT_COMPLETED.equals(action)
                ...
                && !"com.kageksu.kagesu.magica.LAUNCH".equals(action)) {
            return;
        }
