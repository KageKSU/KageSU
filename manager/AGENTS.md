...
The application code is rooted at `com.kageksu.kagesu`.
...
Repository implementations belong under `com.kageksu.kagesu.data` and its subpackages. Keep
...
```text
com.kageksu.kagesu.ui.component
```
...
```text
com.kageksu.kagesu.ui.component.settings
```
...
```text
com.kageksu.kagesu.ui.component.settings.material3internal.AnimatedShape.kt
```
...
* Reusable components are under `com.kageksu.kagesu.ui.component`.
* Settings screens use `com.kageksu.kagesu.ui.component.settings` components.
