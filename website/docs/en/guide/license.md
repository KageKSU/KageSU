...
::: tip Compliance Note
When redistributing or modifying KageSU, ensure you comply with all applicable licenses and attribution requirements for each component.
:::

## 🙏 Acknowledgements

KageSU is a fork of [SukiSU-Ultra](https://github.com/SukiSU-Ultra/SukiSU-Ultra), which is itself based on [KernelSU](https://github.com/tiann/KernelSU). KageSU keeps the same GPL licensing as its upstream projects, and we gratefully credit:

- **[SukiSU-Ultra](https://github.com/SukiSU-Ultra/SukiSU-Ultra)** — the upstream project this fork is based on.
- **[KernelSU](https://github.com/tiann/KernelSU)** — the original kernel-based root solution.

Per the GPL, the source for KageSU (including this website) is available at [github.com/KageKSU/KageSU](https://github.com/KageKSU/KageSU).
