...
- [ ] **Kernel Version**: The kernel version in `Settings > About Phone` reflects the KageSU kernel.
...
2.  Visit our [GitHub repository](https://github.com/KageKSU/KageSU) for issues and solutions.
3.  Join our [Telegram community](https://t.me/KageKSU) for live support.
