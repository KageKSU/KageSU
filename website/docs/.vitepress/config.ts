...
export default defineConfig({
  ...
  sitemap: {
    hostname: 'https://kagesu.palaz.uk',
  ...
  transformPageData(pageData) {
    const canonicalUrl = `https://kagesu.palaz.uk${pageData.relativePath}`
      .replace(/index\.md$/, '')
      .replace(/\.md$/, '')
  ...
  head: [
    ...
    ['link', { rel: 'dns-prefetch', href: '//kagesu.palaz.uk' }],
    ...
    ['meta', { name: 'application-name', content: 'KageSU' }],
    ['meta', { name: 'apple-mobile-web-app-title', content: 'KageSU' }],
    ...
    ['meta', { property: 'og:site_name', content: 'KageSU' }],
    ['meta', { property: 'og:url', content: 'https://kagesu.palaz.uk/' }],
    ['meta', { property: 'og:locale', content: 'en_US' }],
    ['meta', { property: 'og:locale:alternate', content: 'zh_CN' }],

    // Twitter optimization for global audience
    ['meta', { property: 'twitter:card', content: 'summary_large_image' }],
    ['meta', { property: 'twitter:site', content: '@kagesu' }],
    ['meta', { property: 'twitter:creator', content: '@kagesu' }],
    ...
    [
      'meta',
      {
        name: 'keywords',
        content:
          'Android root, KernelSU, KageSU, Android kernel, root management, 安卓 root, カーネル, рут',
      },
    ],
    ['meta', { name: 'author', content: 'KageSU Team' }],
    ...
    [
      ...
      JSON.stringify({
        ...
        url: 'https://kagesu.palaz.uk',
        downloadUrl: 'https://github.com/KageKSU/KageSU/releases',
        supportingData: {
          '@type': 'DataCatalog',
  ...
  themeConfig: {
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/KageKSU/KageSU' },
      {
        icon: {
          svg: '<svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-brand-telegram"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M15 10l-4 4l6 6l4 -16l-18 7l4 2l2 6l3 -4" /></svg>',
        },
        link: 'https://t.me/KageKSU',
      },
    ],
    search: {
      provider: 'local',
  ...
  vite: {
    plugins: [
      ...
      GitChangelog({ repoURL: () => 'https://github.com/KageKSU/KageSU' }),
      GitChangelogMarkdownSection({
