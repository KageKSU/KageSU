...
For languages other than English and Chinese Simplified, please don't create pull requests for translations; instead, use [Crowdin](https://crowdin.com/project/KageSU).

## Reporting bugs

Before reporting a bug, please first read the [document](https://kagesu.palaz.uk)
...
When you [Open an issue](https://github.com/KageKSU/KageSU/issues), you **must**:
...
[Open an issue](https://github.com/KageKSU/KageSU/issues) describing the feature you want and your reason for it.
...
```
>- then Joe Smith would upload the patch for KageSU as
```
